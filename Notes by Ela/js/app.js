        ...
        let liTag = `<li class="note">
                        ...
                        <div class="bottom-content">
                            ...
                            <div class="settings">
                                ...
                                <ul class="menu">
                                    <li onclick="updateNote(${id}, '${note.title}', '${filterDesc}')"><i class="uil uil-pen"></i>Güncelle</li>
...
function deleteNote(noteId) {
    let confirmDel = confirm("Bu notu silmek istediğine emin misin?");
...
function updateNote(noteId, title, filterDesc) {
    ...
    popupTitle.innerText = "Notu Güncelle";
